...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/delete-request.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:08 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Delete Account Request | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=SC4E4yHbeXSeRPfsM4D7R51qTiWzxetkllT87xrBBWw-1772448671.8718183-1.0.1.1-ZwloCiwDtF1ijchAtBBf.hTZcCe24UakbtnTHRDBtpU" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
                    ...
                    <ul>
						...
						<li>							
							<ul>
								...
								<li class="active"><a href="delete-request.html"><i class="ti ti-flag-question"></i><span>Delete Request</span></a></li>
							</ul>
						</li>
        ...
        <div class="page-wrapper">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="delete-request.html" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="8159d9a2c4144e817bc29507-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <h5 class="mb-1">Delete Account Request?</h5>
                    <p class="mb-3">Are you sure you want to approve this delete account request</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
                        <a href="delete-request.html" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <h5 class="mb-1">Delete Account Request?</h5>
                    <p class="mb-3">Are you sure you want to reject this delete account request</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
                        <a href="delete-request.html" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
                    </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

    <!-- Custom Json Js -->
	<script src="assets/json/delete-request.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="8159d9a2c4144e817bc29507-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="8159d9a2c4144e817bc29507-|49" defer></script></body>


<!-- Mirrored from crms.dreamstechnologies.com/html/template/delete-request.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:09 GMT -->
</html>