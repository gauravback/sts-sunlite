...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/notifications-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:25 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Settings - Notification  | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=dhmSyGx.dZuKsk0gBOEtdRRlJFp48KepjHxSziqtN9E-1772448675.505907-1.0.1.1-3bSNq9NI1V.0ua.5PI4.1URCf9aXfu.AJO_XiZXtHZA" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="notifications-settings.html" class="active">Notifications</a></li>
        ...
        <div class="page-wrapper">
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										<a href="profile-settings.html" class="d-block p-2 fw-medium">Profile</a>
										<a href="security-settings.html" class="d-block p-2 fw-medium">Security</a>
										<a href="notifications-settings.html" class="d-block p-2 fw-medium active">Notifications</a>
										<a href="connected-apps.html" class="d-block p-2 fw-medium">Connected Apps</a>
									</div>
								</div>
							</div> <!-- end card body -->
						</div> <!-- end card -->
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="f356ea90c11cb083c9beebcf-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>

	<!-- Sticky Sidebar JS -->
	<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>
	<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="f356ea90c11cb083c9beebcf-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="f356ea90c11cb083c9beebcf-|49" defer></script></body>
