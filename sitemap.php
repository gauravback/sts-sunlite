...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/sitemap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:45 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Settings - Sitemap | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=SCldqZ06Vg98kfMS_4LG_sZhpPIc8OOOlpn3qY.ms1g-1772448679.943448-1.0.1.1-qJKRUL7KTKny4VyvkqOs3cJRXmbWS36qM1CqeyazkfQ" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
				...
				<div class="card border-0">
					<div class="card-body pb-0 pt-0 px-2">
						<ul class="nav nav-tabs nav-bordered nav-bordered-primary">
							...
							<li class="nav-item me-3">
								<a href="payment-gateways.html" class="nav-link p-2">
									<i class="ti ti-moneybag me-2"></i>Financial Settings
								</a>
							</li>
							<li class="nav-item">
								<a href="storage.html" class="nav-link p-2 active">
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										<a href="sitemap.html" class="d-block p-2 fw-medium active">Sitemap</a>
										<a href="clear-cache.html" class="d-block p-2 fw-medium">Clear Cache </a>
										<a href="storage.html" class="d-block p-2 fw-medium">Storage</a>
										<a href="cronjob.html" class="d-block p-2 fw-medium">Cronjob</a>
										<a href="ban-ip-address.html" class="d-block p-2 fw-medium">Ban IP Address</a>
										<a href="system-backup.html" class="d-block p-2 fw-medium">System Backup</a>
										<a href="database-backup.html" class="d-block p-2 fw-medium">Database Backup</a>
										<a href="system-update.html" class="d-block p-2 fw-medium">System Update</a>
									</div>
								</div>
							</div>
						</div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="4cf072dfc97490d8d69b382d-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
		...
		<div class="modal fade" id="add_sitemap" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="https://crms.dreamstechnologies.com/html/template/sitemap.html">
				...
				<div class="modal-content">
					...
					<form action="https://crms.dreamstechnologies.com/html/template/sitemap.html">
						<div class="modal-body">
							<div class="mb-0">
								<label class="form-label">Sitemap URL <span class="text-danger">*</span></label>
								<input type="text" class="form-control" value="sitemap18725604.html">
							</div>
						</div>
						<div class="modal-footer">
							<div class="d-flex align-items-center justify-content-end m-0">
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>  
	
    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>

	<!-- Sticky Sidebar JS -->
	<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>
	<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="4cf072dfc97490d8d69b382d-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="4cf072dfc97490d8d69b382d-|49" defer></script></body>
