...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/payments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:02 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=UlvEBkfOkocuo6w1ekFIi3zX2nbhqY8SAvu9V0YQ.Fc-1772448668.918444-1.0.1.1-7Npf_ilNDe7AqJZ6sJHCDBKmUWAvD7J_zYa9Qz6S5FU" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="2d4bc6ec42527b11895907fb-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_view">
        <div class="offcanvas-header border-bottom justify-content-between">
            <h5 class="mb-0">Payment for Invoice<span class=" text-danger ms-2">#274738</span> </h5>
            <div class="d-flex align-items-center">
                <div class="toggle-header-popup">
                    <div class="dropdown table-action me-2">
                        <a href="#" class="btn btn-dropdowns btn-outline-light dropdown-toggle" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Download
                        </a>
        ...
        <div class="offcanvas-body">
            <form action="https://crms.dreamstechnologies.com/html/template/payments.html">
                            ...
                            <div class="row row-gap-2">
                                <div class="col-lg-6 col-12">
                                    <div class="proposal-to">
                                        <h6 class="mb-2 fw-semibold fs-14">CRMS</h6>
                                        <p class="mb-1">3338 Marcus Street Birmingham, AL 35211</p>
                                        <p class="mb-1">Phone : <span class="text-dark">+1 98789 78788</span> </p>
                                        <p class="mb-1">Email : <span class="text-dark"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aac3c4ccc5eacfd2cbc7dac6cf84c9c5c7">[email&#160;protected]</a></span></p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="proposal-to">
                                        <h6 class="mb-2 fw-semibold fs-14">NovaWave LLC </h6>
                                        ...
                                        <p class="mb-1">Email : <span class="text-dark"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d64636b624d68756c607d616823636879">[email&#160;protected]</a></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="details-propsal details-propsals border-bottom pb-3 mb-3">
                            <h6 class="mb-3">Payment Details</h6>
                            <ul class="d-flex align-items-centers justify-content-between gap-2 flex-wrap">
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Payment Date</p>
                                    <h6 class="fs-14 fw-normal">13 May 2024</h6>
                                </li>
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Payment Method</p>
                                    <h6 class="fs-14 fw-normal">Cash</h6>
                                </li>
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Total Amount</p>
                                    <h6 class="fs-14 fw-normal">$96</h6>
                                </li>
                            </ul>
                        </div>
                        <div class="details-propsal">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <h6 class="d-flex fs-14 fw-normal"><span class="text-danger"> Amount Due : </span> $100</h6>
                            </div>
                            <ul class="m-0 border-0 d-flex align-items-centers justify-content-between gap-2 flex-wrap">
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Invoice Number</p>
                                    <h6 class="mb-0"><span
                                            class="badge badge-soft-danger d-inline-flex">#1254057</span></h6>
                                </li>
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Invoice Date</p>
                                    <h6 class="fs-14 fw-normal">13 May 2024</h6>
                                </li>
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Invoice Amount</p>
                                    <h6 class="fs-14 fw-normal">$196</h6>
                                </li>
                                <li>
                                    <p class="fs-13 fw-medium mb-1">Payment Amount</p>
                                    <h6 class="fs-14 fw-normal">$96</h6>
                                </li>
                            </ul>
                        </div>
    ...
    <!-- delete modal -->
    <div class="modal fade" id="delete_payments">
    ...
    <!-- jQuery -->
    <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Custom Json Js -->
	<script src="assets/json/payments-list.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="2d4bc6ec42527b11895907fb-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="2d4bc6ec42527b11895907fb-|49" defer></script></body>
