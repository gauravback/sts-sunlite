...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/edit-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:56:00 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Edit Blog | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=CmrZHahgRaudZ7kzEEwG0yJj78WhnhIRj2ivl11sqVU-1772448852.6351507-1.0.1.1-H_mWCwANTwsi8ppGxfZ2aBm1kwDjH0EZne4a1QrOtdg" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="mb-3">
                            <a href="blogs.html" class="d-inline-flex align-items-center fw-medium"><i class="ti ti-arrow-left me-1"></i>All Blogs</a>
                        </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="65b09aeee97b4d1f45cb89a4-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

	<!-- Select2 Js -->	
    <script src="assets/plugins/select2/js/select2.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="65b09aeee97b4d1f45cb89a4-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="65b09aeee97b4d1f45cb89a4-|49" defer></script></body>
