...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/domain.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:53:25 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Domain | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=zPSkiDudSvQWN.gIM_R10hUOd5cyPmV1TjA2YRy1BQY-1772448664.6926458-1.0.1.1-9lCRBUsUrnES_9axN.0N0.w38aOeKv1iWPr0cb4FikM" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="subscription.html" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="0379ddaf23476d1bfd83b6f2-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
		...
		<div class="modal fade" id="domain_approved">
			<div class="modal-dialog modal-dialog-centered modal-md">
				<div class="modal-content">
					...
					<form action="https://crms.dreamstechnologies.com/html/template/domain.html">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-sm border avatar-rounded p-1">
                                                <img src="assets/img/icons/company-icon-01.svg" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium fs-14 mb-0"><a href="#">NovaWave LLC</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body border-top">
                                        ...
                                        <div class="row align-items-center row-gap-3">
                                            ...
                                            <div class="col-md-4">
                                                <div>
                                                    <p class="fs-14 mb-1">Register Date</p>
                                                    <p class="fs-14 fw-semibold text-dark mb-0">25 Oct 2024</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- delete modal -->
        <div class="modal fade" id="delete_domain">
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script> 
    
    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="0379ddaf23476d1bfd83b6f2-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="0379ddaf23476d1bfd83b6f2-|49" defer></script></body>
