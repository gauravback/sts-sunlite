...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/notes.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:52:50 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=l59YDtYf62cAeR099N75ZCriJ24tOq27QwGrFIMA0bw-1772448662.3595765-1.0.1.1-PaWJi8PEuBfwyTTJNkYayfXYlHSWNs_uPKYCabbAxVo" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
                    ...
                    <ul>
						...
						<li>
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-brand-airtable"></i><span>Applications</span><span class="menu-arrow"></span></a>
									<ul>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="aa1c75b0805c828d31ed0c02-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
        ...
        <div class="modal fade" id="add_note">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="https://crms.dreamstechnologies.com/html/template/notes.html">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                            ...
                            <a href="notes.html" class="btn btn-danger">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="page-wrapper-new p-0">
                        <div class="content">
                            <div class="modal-header">
                                <div class="d-flex align-items-center">
                                    <h6 class="modal-title mb-0">Notes</h6>
                                </div>
                                <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
    ...
    <!-- JQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

	<!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script> 

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

    <!-- Sticky Sidebar JS -->
    <script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>
    <script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>
    <script src="assets/js/form-quilljs.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

    <!-- Flatpickr JS -->
	<script src="assets/plugins/flatpickr/flatpickr.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

	<!-- Main JS -->
    <script src="assets/js/script.js" type="aa1c75b0805c828d31ed0c02-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="aa1c75b0805c828d31ed0c02-|49" defer></script></body>
