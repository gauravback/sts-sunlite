...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/packages.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:53:25 GMT -->
<head>

    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Packages | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=7shrwOnQ7Va6w5OaKr7y47vI5RmtuTF.RWjl7J4CwU8-1772448664.418069-1.0.1.1-xN4FI9HkIqLYl_tYBn.eF7gDobsyecpx44TDdsPG4JU" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="packages.html" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="28563538cf4f4cf1b8ddf9b7-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
                ...
                <form action="https://crms.dreamstechnologies.com/html/template/packages.html">
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="mb-3">
										<div class="d-flex justify-content-between">
											<label class="form-label">Plan Currency<span class="text-danger"> *</span></label>
											<span class="text-primary d-md-flex align-items-center"><i class="ti ti-info-circle-filled text-danger me-1"></i>Set 0 for free</span>
										</div>
										<select class="select">
											<option>Select</option>
											<option>Fixed</option>
								...
								<div class="col-lg-12">
									<div class="d-flex align-items-center justify-content-between mb-3">
										<h6 class="fs-14 fw-semibold">Plan Modules</h6>
										<div class="form-check d-flex align-items-center">
											<label class="form-check-label mt-0 fw-normal">
								...
								<div class="row align-items-center gx-3">
                                    ...
                                    <div class="col-md-6">
										<div class="d-flex align-items-center flex-wrap mb-0">
                                            ...
                                            <label class="form-check-label mt-0 text-dark">										
												Access Trial
                                            </label>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="d-flex align-items-center justify-content-between mb-3">
										...
										<div class="form-check d-flex align-items-center">
											<label class="form-check-label mt-0 fw-normal">
												<input class="form-check-input" type="checkbox" id="select-all-3">
												Select All
											</label>
										</div>
									</div>
        ...
        <!-- delete modal -->
        <div class="modal fade" id="delete_packages">
            <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
                <div class="modal-content rounded-0">
                    <div class="modal-body p-4 text-center position-relative">
                        ...
                        <p class="mb-3">Are you sure you want to remove package you selected.</p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script> 
    
    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="28563538cf4f4cf1b8ddf9b7-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="28563538cf4f4cf1b8ddf9b7-|49" defer></script></body>
