...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/gdpr-cookies.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:39 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Settings - GDPR | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="4cc74a000d48310f858de46c-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=B8oM1LRM6UKhwuyadozYQA0wQ1L.eiIhsh49i1SZbz4-1772448678.8176162-1.0.1.1-faUB6CbHH7w6cNL9v7W7knYDeT7_t1ox1VnNETLiQ3U" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="gdpr-cookies.html" class="active">GDPR Cookies</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a href="javascript:void(0);">
        ...
        <div class="page-wrapper">
				...
				<div class="card border-0">
					<div class="card-body pb-0 pt-0 px-2">
						<ul class="nav nav-tabs nav-bordered nav-bordered-primary">
							...
							<li class="nav-item me-3">
								<a href="email-settings.html" class="nav-link p-2 active">
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										<a href="email-settings.html" class="d-block p-2 fw-medium">Email Settings</a>
										<a href="sms-gateways.html" class="d-block p-2 fw-medium">SMS Gateways</a>
										<a href="gdpr-cookies.html" class="d-block p-2 fw-medium active">GDPR Cookies</a>
									</div>
								</div>
							</div> <!-- end card body -->
						</div> <!-- end card -->
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="4cc74a000d48310f858de46c-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="4cc74a000d48310f858de46c-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

	<!-- Profile Upload JS -->
	<script src="assets/js/profile-upload.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

	<!-- Sticky Sidebar JS -->
	<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="4cc74a000d48310f858de46c-text/javascript"></script>
	<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="4cc74a000d48310f858de46c-text/javascript"></script>
    <script src="assets/js/form-quilljs.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="4cc74a000d48310f858de46c-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="4cc74a000d48310f858de46c-|49" defer></script></body>
