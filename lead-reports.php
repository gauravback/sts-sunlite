...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/lead-reports.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:52:30 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="595ad95f9e4440800702933b-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=hW5dionjfO6_SGviM8Xeicbst4tc0w6AXrbN4u9m3Y8-1772448658.3287795-1.0.1.1-Ul.kptKv1c17TA1xVWK9ZnVHfiKnfMEDusEWaOeXTuI" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
						...
						<li>
							<ul>
								<li class="submenu">
									...
									<ul>
										<li><a href="lead-reports.html" class="active">Lead Reports</a></li>
        ...
        <div class="page-wrapper">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="lead-reports.html" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="595ad95f9e4440800702933b-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
				...
				<div class="modal-content">
                    ...
                    <form action="#">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-light btn-sm me-2" data-bs-dismiss="modal">Cancel</button>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="595ad95f9e4440800702933b-text/javascript"></script> 
    
    <!-- Apexchart JS -->
	<script src="assets/plugins/apexchart/apexcharts.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>
	<script src="assets/plugins/apexchart/chart-data.js" type="595ad95f9e4440800702933b-text/javascript"></script>

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="595ad95f9e4440800702933b-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>

	<!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="595ad95f9e4440800702933b-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/json/leads-reports.js" type="595ad95f9e4440800702933b-text/javascript"></script>
    <script src="assets/js/script.js" type="595ad95f9e4440800702933b-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="595ad95f9e4440800702933b-|49" defer></script></body>
