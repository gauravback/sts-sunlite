...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/pages.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:10 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=5RH6f2979EHi5C6j0wX7ZnKvhJ6TNS4it5qUvnlt5mw-1772448672.7803879-1.0.1.1-h0rCgKmBDIykgDbmh8wXVQSY55zEWrLpTLBfww8ku0U" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar-inner" data-simplebar>                
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
							<ul>
								<li class="active"><a href="pages.html"><i class="ti ti-page-break"></i><span>Pages</span></a></li>
								<li class="submenu">
									<a href="javascript:void(0);">
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="add-page.html" class="btn btn-primary"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add New Page</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages.html" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="e437b033975cd046ea0b2bc3-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <p class="mb-3">Are you sure you want to remove Pages you selected.</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
                        <a href="pages.html" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

    <!-- Custom Json Js -->
	<script src="assets/json/pages-list.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="e437b033975cd046ea0b2bc3-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="e437b033975cd046ea0b2bc3-|49" defer></script></body>


<!-- Mirrored from crms.dreamstechnologies.com/html/template/pages.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:54:12 GMT -->
</html>