...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/company-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:48 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Companies Details | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=qtnyLT56GQ6ynh58TIofQkogSvCfNnABkxRGRGzR5AI-1772448806.9960089-1.0.1.1-lsOoKh7k.vDb3SbRxeOtterEX5aaeSufpWANdAnrxjk" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="row">
					<div class="col-md-12">
						...
						<div class="mb-3">
							<a href="companies.html"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Companies</a>
						</div>
							...
							<div class="card-body p-3">
								...
								<div class="border-bottom mb-3 pb-3">
									<div class="d-flex align-items-center mb-2">
										...
										<p class="mb-0"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bbd5d4cddaccdacddefbdcd6dad2d795d8d4d6">[email&#160;protected]</a></p>
									</div>
									<div class="d-flex align-items-center mb-2">
										<span class="avatar avatar-xs bg-light p-0 flex-shrink-0 rounded-circle text-dark me-2">
		...
		<!-- Add Compose -->
		<div class="modal fade" id="add_compose" role="dialog">
						...
						<form action="#">
							...
							<div>
								<div class="text-center d-flex align-items-center justify-content-center">
									...
									<button class="btn btn-primary me-2" type="button">Draft</button>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Sticky Sidebar JS -->
	<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>
	<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="d736bf2f9cf4fc23608c0983-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="d736bf2f9cf4fc23608c0983-|49" defer></script></body>


<!-- Mirrored from crms.dreamstechnologies.com/html/template/company-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:49 GMT -->
</html>