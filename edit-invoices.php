...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/edit-invoices.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:48 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Edit Invoice | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=iTfKQOfVr5DKv0ChBwpyBBAi31as3E03WYDXZGVWYJc-1772448797.024376-1.0.1.1-mcABuMeo4sxsmdHsT1CK_BGZK_Ms_6OEoCAKQmtMQ4s" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="invoice.html" class="active">Invoices</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a href="#">
        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fw-bold mb-0 d-flex align-items-center"><a href="invoice.html"><i class="ti ti-chevron-left me-1 fs-14"></i>Invoices</a></h6>
                    </div>
                </div>
                <!-- End Page Header -->
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="8a4135a25b986ce86d8bb012-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="8a4135a25b986ce86d8bb012-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="8a4135a25b986ce86d8bb012-|49" defer></script></body>
