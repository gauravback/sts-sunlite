...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/leads-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:51 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=hKf7TVikzgDv2rJepJ9pldJPHtlO5Pol41SKNgwdQUo-1772448815.1168256-1.0.1.1-My96zDx8qlfaTpExeSue8SmjzfTT5Dbb2MXZwJOQwKE" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="row">
					<div class="col-md-12">
						...
						<div class="mb-3">
							<a href="leads.html"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Leads</a>
						</div>
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="f8b8669ccacf56a2670c705f-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="https://crms.dreamstechnologies.com/html/template/leads-details.html">
			...
			<div class="offcanvas-body">
				<form action="https://crms.dreamstechnologies.com/html/template/leads-details.html">
					<div class="accordion accordion-bordered" id="main_accordion2">
									...
									<div class="row">
											...
											<div class="d-flex align-items-center mb-3">
												<div class="avatar avatar-xxl border border-dashed me-3 flex-shrink-0">
													<div class="position-relative d-flex align-items-center">
														...
														<a href="javascript:void(0);" class="fs-12 text-danger border-0 badge-soft-danger rounded-circle p-1 trash-top d-flex align-items-center justify-content-center position-absolute end-0 top-0"><i class="ti ti-trash"></i></a>
													</div>
												</div>
												<div class="d-inline-flex flex-column align-items-start">
													<div class="drag-upload-btn btn btn-sm btn-primary position-relative mb-2">
										...
										<div class="col-md-6">
											<div class="mb-3">
												<div class="d-flex align-items-center justify-content-between">
													<label class="form-label">Deals</label>
													<a href="#" class="label-add link-primary mb-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add_2"><i class="ti ti-plus me-1"></i>Add New</a>
												</div>
												<select class="select">
													<option>Select</option>
										...
										<div class="col-md-6">
											<div class="mb-3">
												...
												<div class="input-group w-auto input-group-flat">
													<input type="text" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="10 Jun, 1997">
													<span class="input-group-text">
														<i class="ti ti-calendar"></i>
													</span>
												</div>
										...
										<div class="col-md-12">
											<div class="mb-0">
												<label class="form-label">Description <span class="text-danger">*</span></label>
												<textarea class="form-control" rows="3">Key decision-maker overseeing operations and strategic planning. Responsible for approving major deals and partnerships. Prefers direct communication via email.</textarea>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded" data-bs-toggle="collapse" data-bs-target="#address2">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded" data-bs-toggle="collapse" data-bs-target="#social2">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded" data-bs-toggle="collapse" data-bs-target="#access-info2">
			...
			<div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
				<div class="modal-content rounded-0">
					<div class="modal-body p-4 text-center position-relative">
						...
						<p class="mb-3">Are you sure you want to remove call log you selected.</p>
		...
		<!-- delete modal -->
		<div class="modal fade" id="delete_call">
			<div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
				<div class="modal-content rounded-0">
					<div class="modal-body p-4 text-center position-relative">
						<div class="mb-3 position-relative z-1">
			...
			<div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
				<div class="modal-content rounded-0">
					<div class="modal-body p-4 text-center position-relative">
						...
						<h5 class="mb-1">Delete Confirmation</h5>
						<p class="mb-3">Are you sure you want to remove note you selected.</p>
						<div class="d-flex justify-content-center">
							<a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
							<a href="#" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
						</div>
			...
			<div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
				<div class="modal-content rounded-0">
					<div class="modal-body p-4 text-center position-relative">
						...
						<h5 class="mb-1">Delete Confirmation</h5>
						<p class="mb-3">Are you sure you want to remove File you selected.</p>
						<div class="d-flex justify-content-center">
							<a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
							<a href="#" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
						</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="btn-close custom-btn-close border p-1 me-0 text-dark" data-bs-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<form action="https://crms.dreamstechnologies.com/html/template/leads-details.html">
				...
				<div class="modal-content">
					...
					<form action="https://crms.dreamstechnologies.com/html/template/leads-details.html">
						<div class="modal-body">
							<div class="mb-3">
								<label class="form-label">Title <span class="text-danger"> *</span></label>
								<input class="form-control" type="text" value="Team meet at Starbucks">
							</div>
							<div class="mb-3">
								<label class="form-label">Note <span class="text-danger"> *</span></label>
								<textarea class="form-control" rows="4">A project review evaluates the success of an initiative and identifies areas for improvement. </textarea>
							</div>
							<div class="mb-3">
								<label class="form-label">Attachment <span class="text-danger">*</span></label>
								<div class="file-upload drag-file w-100 d-flex bg-light border shadow align-items-center justify-content-center flex-column">
		...
		<!-- Edit Call Log -->
		<div class="modal fade" id="edit_call" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
								...
								<div class="col-md-12">
									...
									<div>
										<div class="form-check mb-1">
											...
											<label class="form-check-label" for="customCheck2">Create a follow up task</label>
										</div>
									</div>
								</div>
							</div>
		...
		<!-- Connect Account -->
		<div class="modal fade" id="create_email" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						...
						<div>
							<h6 class="fs-14 fw-medium mb-2">Sync emails from</h6>
							<div>
								<div class="form-check mb-1">
									<input type="radio" id="customRadio14" name="customRadio" class="form-check-input" checked>
									<label class="form-check-label" for="customRadio14">Now</label>
								</div>
								<div class="form-check mb-1">
									<input type="radio" id="customRadio15" name="customRadio" class="form-check-input">
									<label class="form-check-label" for="customRadio15">1 Month Ago</label>
								</div>
								<div class="form-check mb-1">
									<input type="radio" id="customRadio16" name="customRadio" class="form-check-input">
									<label class="form-check-label" for="customRadio16">3 Month Ago</label>
								</div>
								<div class="form-check mb-1">
									<input type="radio" id="customRadio17" name="customRadio" class="form-check-input">
									<label class="form-check-label" for="customRadio17">6 Month Ago</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="add-info-fieldset">
								...
								<form action="https://crms.dreamstechnologies.com/html/template/leads-details.html">
									<div class="contact-input-set">
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="signature-wrap bg-light p-3 rounded border mb-3 pb-0">
													...
													<ul class="nav sign-item">
														<li class="nav-item mb-2">
															<span class=" mb-0" data-bs-toggle="tab" data-bs-target="#nosign">
																...
																<label for="sign1" class="text-body"><span class="sign-title text-dark d-block mb-1">No Signature</span>This document does not require a signature before acceptance.</label>
															</span>
														</li>
														<li class="nav-item">
															<span class="active mb-0" data-bs-toggle="tab" data-bs-target="#use-esign">
																...
																<label for="sign2" class="text-body"><span class="sign-title text-dark d-block mb-1">Use e-signature</span>This document require e-signature before acceptance.</label>
															</span>
														</li>
													</ul>
														...
														<div class="tab-pane show active" id="use-esign">
															<div class="sign-content">
																<div class="row">
																	<div class="col-md-6">
																		<div class="mb-3">
																			<label class="form-label">Recipients Name <span class="text-danger">*</span></label>
																	...
																	<div class="col-md-6">
																		<div class="d-flex align-items-center">
																			<div class="float-none mb-3 me-3 w-100">
																				<label class="form-label">Recipients Email <span class="text-danger">*</span></label>
											...
											<div class="col-lg-12 text-end form-wizard-button border-top pt-3">
							...
							<fieldset>
								<form action="https://crms.dreamstechnologies.com/html/template/contact-details.html">
									<div class="contact-input-set">
										<div class="row">
											<div class="col-lg-12">
												<div class="signature-wrap bg-light p-3 rounded border mb-3 pb-0">
													<h6 class="mb-2 fw-semibold fs-14">Send the document to following signers</h6>
											...
											<div class="col-lg-12">
												...
												<div class="bg-soft-success text-success border border-success rounded p-2">
													<p class="mb-0"><i class="ti ti-circle-check-filled me-1"></i> Document sent successfully to the selected recipients</p>
												</div>
											</div>
											<div class="col-lg-12 text-end form-wizard-button pt-3 border-top mt-3">
												<button class="btn btn-light me-2" type="reset">Cancel</button>
								...
								<ul>
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-19.jpg" alt="img" class="avatar avatar-sm rounded-circle">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-20.jpg" alt="img" class="avatar avatar-sm rounded-circle">
												<a href="#">Sharon Roy</a>
											</span>
										</label>
									</li>
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-21.jpg" alt="img" class="avatar avatar-sm rounded-circle">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-01.jpg" alt="img" class="avatar avatar-sm rounded-circle">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-16.jpg" alt="img" class="avatar avatar-sm rounded-circle">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs d-flex align-items-center mb-3">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="assets/img/profiles/avatar-22.jpg" alt="img" class="avatar avatar-sm rounded-circle">
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Sticky Sidebar JS -->
	<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>
	<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="f8b8669ccacf56a2670c705f-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="f8b8669ccacf56a2670c705f-|49" defer></script></body>
