...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/deals-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:49 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=RTcO6pBcAnwmb5qZqoqk4w1F7MG1GLS8wJwBvhlD100-1772448807.8108242-1.0.1.1-77j2xvCaAKcMPeqqw2tZoPN6ujCR.GUx6s3GewneGFs" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">                                
                                ...
                                <div class="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
									<a href="deals-list.html" class="btn btn-sm p-1 border-0 fs-14 active"><i class="ti ti-list-tree"></i></a>
									<a href="deals.html" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
								</div>
                            </div>
                        </div>
                        <!-- table header -->
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="3e6876c0e5c40b177a9e3406-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
        ...
        <div class="offcanvas-body">
            <form action="https://crms.dreamstechnologies.com/html/template/deals-list.html">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);" class="label-add link-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_pipeline">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="input-tags form-control border-0 h-100" data-choices data-choices-limit="infinite" data-choices-removeItem type="text" value="Devops Design, MargrateDesign, UI for Chat">
                        </div>
                    </div>
                   <div class="col-md-6">
                        <div class="mb-3">
            ...
            <form action="https://crms.dreamstechnologies.com/html/template/deals-list.html">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label">Deal Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="Annual Software Subscription">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Period Value <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" value="Collins">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                   ...
                   <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Due Date <span class="text-danger">*</span></label>
                            <div class="input-group w-auto input-group-flat">
                                <input type="text" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="20 Jan 2025">
                                <span class="input-group-text">
                                    <i class="ti ti-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Expected Closing Date <span class="text-danger">*</span></label>
                            <div class="input-group w-auto input-group-flat">
                                <input type="text" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="15 May 2025">
                                <span class="input-group-text">
                                    <i class="ti ti-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Follow Up Date <span class="text-danger">*</span></label>
                            <div class="input-group w-auto input-group-flat">
                                <input type="text" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="20 Sep 2025">
                                <span class="input-group-text">
                                    <i class="ti ti-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label class="form-label">Description <span class="text-danger">*</span></label>
                            <div class="editor pages-editor">Key decision-maker overseeing operations and strategic planning. Responsible for approving major deals and partnerships. Prefers direct communication via email.</div>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-center justify-content-end">
                    <button type="button" data-bs-dismiss="offcanvas" class="btn btn-light me-2">Cancel</button>
                    <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#create_success">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    <div class="mb-3 position-relative z-1">
                        <span class="avatar avatar-xl badge-soft-success border-0 text-success rounded-circle"><i class="ti ti-medal fs-24"></i></span>
                    </div>
                    <h5 class="mb-1">Deal Created Successfully!!!</h5>
                    <p class="mb-3">View the details of deal, created</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
                        <a href="deals-details.html" class="btn btn-primary position-relative z-1 w-100">View Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- delete modal -->
    <div class="modal fade" id="delete_deal">
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    <div class="mb-3 position-relative z-1">
                    ...
                    <p class="mb-3">Are you sure you want to remove deal you selected.</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
	...
	<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_pipeline">
		<div class="offcanvas-header border-bottom">
			<h5 class="mb-0">Add New Pipeline</h5>
			<button type="button"
				class="btn-close custom-btn-close border p-1 me-0 d-flex align-items-center justify-content-center rounded-circle"
				data-bs-dismiss="offcanvas" aria-label="Close">
			</button>
		...
		<div class="offcanvas-body">
			<form action="https://crms.dreamstechnologies.com/html/template/deals-list.html">
				<div>
					...
					<div class="mb-3">
						<div class="pipe-title d-flex align-items-center justify-content-between mb-2">
							<label class="form-label m-0">Pipeline Stages</label>
							<a href="#" class="add-stage link-primary" data-bs-toggle="modal" data-bs-target="#add_stage"><i
									class="ti ti-plus me-1"></i>Add New</a>
						</div>
						<div class="pipeline-listing">
							<div class="pipeline-item d-flex align-items-center justify-content-between p-2 shadow-sm bg-white mb-1 border-start border-3 border-warning">
								<p class="mb-0 fw-semibold me-3 text-dark"><i class="ti ti-grip-vertical text-body"></i> Inpipeline</p>
								<div class="action-pipeline">
									<a href="#" data-bs-toggle="modal" data-bs-target="#edit_stage" class="btn btn-sm btn-outline-light border-0"><i
											class="ti ti-edit me-1"></i>Edit</a>
									<a href="#" data-bs-toggle="modal" data-bs-target="#delete_stage" class="btn btn-sm btn-outline-light border-0"><i
											class="ti ti-trash me-1"></i>Delete</a>
								</div>
							</div>
							<div class="pipeline-item d-flex align-items-center justify-content-between p-2 shadow-sm bg-white mb-1 border-start border-3 border-warning">
								<p class="mb-0 me-3 fw-semibold text-dark"><i class="ti ti-grip-vertical text-body"></i> Follow Up</p>
								<div class="action-pipeline">
									<a href="#" data-bs-toggle="modal" data-bs-target="#edit_stage" class="btn btn-sm btn-outline-light border-0"><i
											class="ti ti-edit me-1"></i>Edit</a>
									<a href="#" data-bs-toggle="modal" data-bs-target="#delete_stage" class="btn btn-sm btn-outline-light border-0"><i
                            ...
                            <div class="pipeline-item d-flex align-items-center justify-content-between p-2 shadow-sm bg-white mb-1 border-start border-3 border-warning">
								<p class="mb-0 me-3 fw-semibold text-dark"><i class="ti ti-grip-vertical text-body"></i> Schedule Service</p>
								<div class="action-pipeline">
									<a href="#" data-bs-toggle="modal" data-bs-target="#edit_stage" class="btn btn-sm btn-outline-light border-0"><i
											class="ti ti-edit me-1"></i>Edit</a>
									<a href="#" data-bs-toggle="modal" data-bs-target="#delete_stage" class="btn btn-sm btn-outline-light border-0"><i
					...
					<div class="mb-3">
						...
						<div class="d-flex flex-wrap access-item nav mb-3">
							<div class="radio-btn me-2" data-bs-toggle="tab" data-bs-target="#all">
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="select-person">
								<div class="access-wrapper">
									<div class="d-flex align-items-center mb-1 justify-content-between shadow-sm rounded p-2 bg-white border">
										<div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="assets/img/profiles/avatar-21.jpg" alt="Image" class="rounded-circle">
                                            </div>
                                            <span>Vaughan Lewis</span>
                                        </div>
										<a href="javascript:void(0);" class="link-primary">Remove</a>
									</div>
									<div class="d-flex align-items-center mb-1 justify-content-between shadow-sm rounded p-2 bg-white border">
										<div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="assets/img/profiles/avatar-08.jpg" alt="Image" class="rounded-circle">
                                            </div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title mb-0">Add New Stage</h5>
                ...
                <form action="https://crms.dreamstechnologies.com/html/template/deals-list.html">
                    <div class="modal-body">					
                        <div class="mb-0">
                            <label class="form-label">Stage Name<span class="ms-1 text-danger">*</span></label>
                            <input type="text" class="form-control">
                        </div>						
                    </div>
                    <div class="modal-btn text-end p-3 border-top">
                        <a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
                        <button type="submit" class="btn btn-danger">Create New</button>
                    </div>
                </form>
			</div>
		</div>
	...
	<div class="modal custom-modal fade" id="edit_stage" role="dialog">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title mb-0">Edit Stage</h5>
					<button class="btn-close custom-btn-close border p-1 me-0 text-dark" data-bs-dismiss="modal" aria-label="Close">
					</button>
				</div>
                <form action="https://crms.dreamstechnologies.com/html/template/deals-list.html">
                    <div class="modal-body">					
                        <div class="mb-0">
                            <label class="form-label">Edit Stage<span class="ms-1 text-danger">*</span></label>
    ...
    <!-- delete stage -->
    <div class="modal fade" id="delete_stage">
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    <div class="mb-3 position-relative z-1">
                    ...
                    <h5 class="mb-1">Remove Stage</h5>
                    <p class="mb-3">Are you sure you want to remove stage you selected.</p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-light position-relative z-1 me-2 w-100" data-bs-dismiss="modal">Cancel</a>
                        <a href="#" class="btn btn-primary position-relative z-1 w-100" data-bs-dismiss="modal">Yes, Delete</a>
                    </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Custom Json Js -->
	<script src="assets/json/deal-list.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="3e6876c0e5c40b177a9e3406-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3e6876c0e5c40b177a9e3406-|49" defer></script></body>
