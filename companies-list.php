...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/companies-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:55:48 GMT -->
<head>

	<!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Companies List | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=8.5k73acV3jn5M5Ok_S2szwpLMxZ72yp6TPOck5grrw-1772448806.3307593-1.0.1.1-0kzdo0SxMIEpxqUJrlQVCrd7ZrI5XYGSFCnSKVXODt4" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="6595f1ae7feebd493405edc5-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>  

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>
    
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Choices Js -->	
    <script src="assets/plugins/choices.js/public/assets/scripts/choices.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Mobile Input -->
    <script src="assets/plugins/intltelinput/js/intlTelInput.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Flatpickr JS -->
    <script src="assets/plugins/flatpickr/flatpickr.min.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Custom Json Js -->
	<script src="assets/json/companies-list.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="6595f1ae7feebd493405edc5-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="6595f1ae7feebd493405edc5-|49" defer></script></body>
