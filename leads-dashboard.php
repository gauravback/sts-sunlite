...
<!-- Mirrored from crms.dreamstechnologies.com/html/template/leads-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Mar 2026 10:52:42 GMT -->
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>
...
<body><a href="https://crms.dreamstechnologies.com/cdn-cgi/content?id=cjpX8Th6Cld0rwiIVFJtKTYq9j3dehq1n2YnfjaCiqU-1772448660.518151-1.0.1.1-XcZ0Li.OTuI6yXRuw1YVBVOaah9S_i5x35gVE1Rde4M" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="e20494aec5aa4e36ddee32ca-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/js/jquery.dataTables.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>
    <script src="assets/plugins/datatables/js/dataTables.bootstrap5.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

	<!-- Daterangepicker JS -->
	<script src="assets/js/moment.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

	<!-- Apexchart JS -->
	<script src="assets/plugins/apexchart/apexcharts.min.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>
	<script src="assets/plugins/apexchart/chart-data.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>
	
	<!-- Custom Json Js -->	
	<script src="assets/json/lead-project.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="e20494aec5aa4e36ddee32ca-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="e20494aec5aa4e36ddee32ca-|49" defer></script></body>
