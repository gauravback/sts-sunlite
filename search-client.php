...
<div class="container-fluid py-5">
    <div class="search-container">
        <div class="text-center mb-5">
            <h2 class="hero-title">Initiate  Goverment Sale</h2>
            <p class="hero-subtitle mt-2">Find an existing Customer to lock the deal</p>
        </div>
        ...
        if(query.length > 1){
            ...
            typingTimer = setTimeout(function() {
                $.ajax({
                    url: "ajax-search.php", 
                    method: "POST",
                    // Yahan humne type add kiya hai taaki backend siraf customer filter kare
                    data: {search: query, type: "customer_only"},
